 ...
 */
public class B1_09_TodayTaskActivity extends BaseActivity implements
		IXListViewListener, OnItemClickListener {
	private static int PERPAGE = 10;// 每页现实的的任务数为10
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			sdate = DateUtil.longToString(nowTime, "yyyy-MM-dd");// 当前周
			edate = DateUtil.longToString(nowTime + 1000 * 3600 * 24 * 7 * 0,
					"yyyy-MM-dd");// 下周
