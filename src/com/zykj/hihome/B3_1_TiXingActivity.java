...
public class B3_1_TiXingActivity extends BaseActivity {
	...
	private void initView() {
		...
		clockAdapter=new CommonAdapter<String>(B3_1_TiXingActivity.this,R.layout.ui_b3_1_item_clock ,clocksList) {
		...
		addClockAdapter=new CommonAdapter<String>(B3_1_TiXingActivity.this,R.layout.ui_b3_1_item_add_clock,getData()) {
