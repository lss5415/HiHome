 ...
 * 周任务总览
 */
public class B1_02_ZhouRenWuZongLan extends BaseActivity implements OnItemClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			edate = DateUtil.longToString(nowTime+1000*3600*24*7, "yyyy-MM-dd");//下周
