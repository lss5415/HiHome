...
public class B3_1_1_RepeatActivity extends BaseActivity {
	...
	private void initView() {
		...
		repeatAdapter=new CommonAdapter<String>(B3_1_1_RepeatActivity.this,R.layout.ui_b3_1_item_clock ,repeatList) {
		...
		addRepeatAdapter=new CommonAdapter<String>(B3_1_1_RepeatActivity.this,R.layout.ui_b3_1_item_add_clock,getData()) {
